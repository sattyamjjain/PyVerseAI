...
def handle_student_registration():
    ...
    register(req_json['name'], req_json['university_id'], req_json['password'], req_json.get('role', 'STUDENT'))
...
def handle_book_slot(auth):
    req_json = request.json
    book_slot(req_json['id'], req_json['student_name'], req_json['start_time'], req_json.get('end_time'))
